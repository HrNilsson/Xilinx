...
0.0002default:defaultZ17-268
J
>Phase 1.1.1 Mandatory Logic Optimization | Checksum: cc22c132
*common
‰

%s
*constraints2r
^Time (s): cpu = 00:00:01 ; elapsed = 00:00:00.178 . Memory (MB): peak = 727.871 ; gain = 0.0002default:default
ƒ

Phase %s%s
101*constraints2
...
U
IPhase 1.1.2 Build Super Logic Region (SLR) Database | Checksum: cc22c132
*common
‰

%s
*constraints2r
^Time (s): cpu = 00:00:01 ; elapsed = 00:00:00.213 . Memory (MB): peak = 727.871 ; gain = 0.0002default:default
k

Phase %s%s
101*constraints2
...
=
1Phase 1.1.3 Add Constraints | Checksum: cc22c132
*common
‰

%s
*constraints2r
^Time (s): cpu = 00:00:01 ; elapsed = 00:00:00.215 . Memory (MB): peak = 727.871 ; gain = 0.0002default:default
h

Phase %s%s
101*constraints2
...
;
/Phase 1.1.4 Build Macros | Checksum: 17b69f647
*common
‰

%s
*constraints2r
^Time (s): cpu = 00:00:01 ; elapsed = 00:00:00.732 . Memory (MB): peak = 727.871 ; gain = 0.0002default:default
|

Phase %s%s
101*constraints2
...
O
CPhase 1.1.5 Implementation Feasibility check | Checksum: 17b69f647
*common
‰

%s
*constraints2r
^Time (s): cpu = 00:00:01 ; elapsed = 00:00:00.998 . Memory (MB): peak = 727.871 ; gain = 0.0002default:default
k

Phase %s%s
101*constraints2
...
>
2Phase 1.1.6 Pre-Place Cells | Checksum: 17b69f647
*common
…

%s
*constraints2n
ZTime (s): cpu = 00:00:01 ; elapsed = 00:00:01 . Memory (MB): peak = 727.871 ; gain = 0.0002default:default
Ž

Phase %s%s
101*constraints2
...
a
UPhase 1.1.7 IO Placement/ Clock Placement/ Build Placer Device | Checksum: 1e584333e
*common
…

%s
*constraints2n
ZTime (s): cpu = 00:00:03 ; elapsed = 00:00:03 . Memory (MB): peak = 729.469 ; gain = 1.5982default:default
v

Phase %s%s
101*constraints2
...
C
7Phase 1.1.8.1.1 Build Clock Data | Checksum: 2d2e6dcc1
*common
…

%s
*constraints2n
ZTime (s): cpu = 00:00:05 ; elapsed = 00:00:04 . Memory (MB): peak = 730.379 ; gain = 2.5082default:default
B
6Phase 1.1.8.1 Place Init Design | Checksum: 1ef8c692f
*common
…

%s
...
ZTime (s): cpu = 00:00:05 ; elapsed = 00:00:04 . Memory (MB): peak = 730.379 ; gain = 2.5082default:default
I
=Phase 1.1.8 Build Placer Netlist Model | Checksum: 1ef8c692f
*common
…

%s
...
Q
EPhase 1.1.9.1 Constrain Global/Regional Clocks | Checksum: 1ef8c692f
*common
…

%s
...
ZTime (s): cpu = 00:00:05 ; elapsed = 00:00:04 . Memory (MB): peak = 730.379 ; gain = 2.5082default:default
F
:Phase 1.1.9 Constrain Clocks/Macros | Checksum: 1ef8c692f
*common
…

%s
...
ZTime (s): cpu = 00:00:05 ; elapsed = 00:00:04 . Memory (MB): peak = 730.379 ; gain = 2.5082default:default
G
;Phase 1.1 Placer Initialization Core | Checksum: 1ef8c692f
*common
…

%s
...
ZTime (s): cpu = 00:00:05 ; elapsed = 00:00:04 . Memory (MB): peak = 730.379 ; gain = 2.5082default:default
@
4Phase 1 Placer Initialization | Checksum: 1ef8c692f
*common
…

%s
...
9
-Phase 2.1 Run Budgeter | Checksum: 1f141be8e
*common
…

%s
*constraints2n
ZTime (s): cpu = 00:00:08 ; elapsed = 00:00:06 . Memory (MB): peak = 737.172 ; gain = 9.3012default:default
;
/Phase 2 Global Placement | Checksum: 2b9bd2bef
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:19 ; elapsed = 00:00:15 . Memory (MB): peak = 745.762 ; gain = 17.8912default:default
h

Phase %s%s
101*constraints2
...
G
;Phase 3.1 Commit Multi Column Macros | Checksum: 2b9bd2bef
*common
†

%s
...
I
=Phase 3.2 Commit Most Macros & LUTRAMs | Checksum: 1cde91266
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:20 ; elapsed = 00:00:16 . Memory (MB): peak = 752.914 ; gain = 25.0432default:default
p

Phase %s%s
101*constraints2
...
C
7Phase 3.3 Area Swap Optimization | Checksum: 18cc17419
*common
†

%s
...
B
6Phase 3.4 Timing Path Optimizer | Checksum: 26f1cd572
*common
†

%s
...
M
APhase 3.5 Commit Small Macros & Core Logic | Checksum: 2aa93e903
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:21 ; elapsed = 00:00:18 . Memory (MB): peak = 754.605 ; gain = 26.7342default:default
l

Phase %s%s
101*constraints2
...
?
3Phase 3.6 Re-assign LUT pins | Checksum: 2aa93e903
*common
†

%s
...
[Time (s): cpu = 00:00:21 ; elapsed = 00:00:18 . Memory (MB): peak = 754.605 ; gain = 26.7342default:default
;
/Phase 3 Detail Placement | Checksum: 2aa93e903
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:22 ; elapsed = 00:00:18 . Memory (MB): peak = 754.605 ; gain = 26.7342default:default
€

Phase %s%s
101*constraints2
...
@
4Phase 4.1 PCOPT Shape updates | Checksum: 2aa6712bb
*common
†

%s
...
Q
EPhase 4.2.1 Post Placement Timing Optimization | Checksum: 28b2f681a
*common
†

%s
...
[Time (s): cpu = 00:00:22 ; elapsed = 00:00:18 . Memory (MB): peak = 754.605 ; gain = 26.7342default:default
H
<Phase 4.2 Post Placement Optimization | Checksum: 28b2f681a
*common
†

%s
...
C
7Phase 4.3 Post Placement Cleanup | Checksum: 28b2f681a
*common
†

%s
...
C
7Phase 4.4.1 Congestion Reporting | Checksum: 28b2f681a
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:23 ; elapsed = 00:00:18 . Memory (MB): peak = 754.605 ; gain = 26.7342default:default
n

Phase %s%s
101*constraints2
...
A
5Phase 4.4.2 updateTiming final | Checksum: 270af4943
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:23 ; elapsed = 00:00:19 . Memory (MB): peak = 754.605 ; gain = 26.7342default:default
p

Phase %s%s
101*constraints2
...
C
7Phase 4.4.3 Dump Critical Paths  | Checksum: 270af4943
*common
†

%s
...
:
.Phase 4.4.4 Restore STA | Checksum: 270af4943
*common
†

%s
...
>
2Phase 4.4.5 Print Final WNS | Checksum: 270af4943
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:24 ; elapsed = 00:00:20 . Memory (MB): peak = 754.605 ; gain = 26.7342default:default
=
1Phase 4.4 Placer Reporting | Checksum: 270af4943
*common
†

%s
...
D
8Phase 4.5 Final Placement Cleanup | Checksum: 268454470
*common
†

%s
...
[Time (s): cpu = 00:00:24 ; elapsed = 00:00:20 . Memory (MB): peak = 754.605 ; gain = 26.7342default:default
S
GPhase 4 Post Placement Optimization and Clean-Up | Checksum: 268454470
*common
†

%s
...
[Time (s): cpu = 00:00:24 ; elapsed = 00:00:20 . Memory (MB): peak = 754.605 ; gain = 26.7342default:default
5
)Ending Placer Task | Checksum: 22f398056
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:00 ; elapsed = 00:00:20 . Memory (MB): peak = 754.605 ; gain = 26.7342default:default
Q
Releasing license: %s
83*common2"
...
28.1602default:defaultZ17-268
^
...

sreport_utilization: Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.100 . Memory (MB): peak = 755.168 ; gain = 0.000
*common
j
...
00:00:00.5822default:default2
755.1682default:default2
0.0002default:defaultZ17-268


...
%s
*constraints2r
^Time (s): cpu = 00:00:01 ; elapsed = 00:00:00.553 . Memory (MB): peak = 762.910 ; gain = 0.0002default:default
É

Phase %s%s
101*constraints2
...
%s
*constraints2r
^Time (s): cpu = 00:00:01 ; elapsed = 00:00:00.599 . Memory (MB): peak = 762.910 ; gain = 0.0002default:default
k

Phase %s%s
101*constraints2
...
%s
*constraints2r
^Time (s): cpu = 00:00:01 ; elapsed = 00:00:00.602 . Memory (MB): peak = 762.910 ; gain = 0.0002default:default
h

Phase %s%s
101*constraints2
...
:
.Phase 1.1.4 Build Macros | Checksum: c2d9f072
*common
Ö

%s
*constraints2n
ZTime (s): cpu = 00:00:02 ; elapsed = 00:00:02 . Memory (MB): peak = 762.910 ; gain = 0.0002default:default
|

Phase %s%s
101*constraints2
...
N
BPhase 1.1.5 Implementation Feasibility check | Checksum: c2d9f072
*common
Ö

%s
*constraints2n
ZTime (s): cpu = 00:00:03 ; elapsed = 00:00:03 . Memory (MB): peak = 762.910 ; gain = 0.0002default:default
k

Phase %s%s
101*constraints2
...
=
1Phase 1.1.6 Pre-Place Cells | Checksum: c2d9f072
*common
Ö

%s
...
a
UPhase 1.1.7 IO Placement/ Clock Placement/ Build Placer Device | Checksum: 180b5abab
*common
Ö

%s
*constraints2n
ZTime (s): cpu = 00:00:06 ; elapsed = 00:00:05 . Memory (MB): peak = 762.910 ; gain = 0.0002default:default
v

Phase %s%s
101*constraints2
...
C
7Phase 1.1.8.1.1 Build Clock Data | Checksum: 1c4892039
*common
Ö

%s
*constraints2n
ZTime (s): cpu = 00:00:10 ; elapsed = 00:00:08 . Memory (MB): peak = 762.910 ; gain = 0.0002default:default
B
6Phase 1.1.8.1 Place Init Design | Checksum: 1a0e277fc
*common
Ö

%s
*constraints2n
ZTime (s): cpu = 00:00:11 ; elapsed = 00:00:09 . Memory (MB): peak = 762.910 ; gain = 0.0002default:default
I
=Phase 1.1.8 Build Placer Netlist Model | Checksum: 1a0e277fc
*common
Ö

%s
...
Q
EPhase 1.1.9.1 Constrain Global/Regional Clocks | Checksum: 1a0e277fc
*common
Ö

%s
...
ZTime (s): cpu = 00:00:11 ; elapsed = 00:00:09 . Memory (MB): peak = 762.910 ; gain = 0.0002default:default
F
:Phase 1.1.9 Constrain Clocks/Macros | Checksum: 1a0e277fc
*common
Ö

%s
...
ZTime (s): cpu = 00:00:11 ; elapsed = 00:00:09 . Memory (MB): peak = 762.910 ; gain = 0.0002default:default
G
;Phase 1.1 Placer Initialization Core | Checksum: 1a0e277fc
*common
Ö

%s
...
ZTime (s): cpu = 00:00:11 ; elapsed = 00:00:09 . Memory (MB): peak = 762.910 ; gain = 0.0002default:default
@
4Phase 1 Placer Initialization | Checksum: 1a0e277fc
*common
Ö

%s
...
;
/Phase 2 Global Placement | Checksum: 1f4c1546b
*common
Ö

%s
*constraints2n
ZTime (s): cpu = 00:00:48 ; elapsed = 00:00:38 . Memory (MB): peak = 765.484 ; gain = 2.5742default:default
h

Phase %s%s
101*constraints2
...
G
;Phase 3.1 Commit Multi Column Macros | Checksum: 1f4c1546b
*common
Ö

%s
...
I
=Phase 3.2 Commit Most Macros & LUTRAMs | Checksum: 16a86b3e5
*common
Ö

%s
*constraints2n
ZTime (s): cpu = 00:00:51 ; elapsed = 00:00:40 . Memory (MB): peak = 770.578 ; gain = 7.6682default:default
p

Phase %s%s
101*constraints2
...
C
7Phase 3.3 Area Swap Optimization | Checksum: 1001d3eee
*common
Ö

%s
*constraints2n
ZTime (s): cpu = 00:00:51 ; elapsed = 00:00:41 . Memory (MB): peak = 770.578 ; gain = 7.6682default:default
o

Phase %s%s
101*constraints2
...
B
6Phase 3.4 Timing Path Optimizer | Checksum: 1b0e59add
*common
Ö

%s
*constraints2n
ZTime (s): cpu = 00:00:52 ; elapsed = 00:00:41 . Memory (MB): peak = 770.621 ; gain = 7.7112default:default
z

Phase %s%s
101*constraints2
...
M
APhase 3.5 Commit Small Macros & Core Logic | Checksum: 228030469
*common
Ö

%s
*constraints2n
ZTime (s): cpu = 00:00:56 ; elapsed = 00:00:45 . Memory (MB): peak = 771.523 ; gain = 8.6132default:default
l

Phase %s%s
101*constraints2
...
?
3Phase 3.6 Re-assign LUT pins | Checksum: 228030469
*common
Ö

%s
*constraints2n
ZTime (s): cpu = 00:00:56 ; elapsed = 00:00:45 . Memory (MB): peak = 771.547 ; gain = 8.6372default:default
;
/Phase 3 Detail Placement | Checksum: 228030469
*common
Ö

%s
...
@
4Phase 4.1 PCOPT Shape updates | Checksum: 1dd80af81
*common
Ö

%s
...
Q
EPhase 4.2.1 Post Placement Timing Optimization | Checksum: 1ec98f369
*common
Ö

%s
*constraints2n
ZTime (s): cpu = 00:00:59 ; elapsed = 00:00:47 . Memory (MB): peak = 772.063 ; gain = 9.1522default:default
H
<Phase 4.2 Post Placement Optimization | Checksum: 1ec98f369
*common
Ö

%s
...
C
7Phase 4.3 Post Placement Cleanup | Checksum: 1ec98f369
*common
Ö

%s
...
C
7Phase 4.4.1 Congestion Reporting | Checksum: 1ec98f369
*common
Ö

%s
...
A
5Phase 4.4.2 updateTiming final | Checksum: 19ec6bbea
*common
Ö

%s
*constraints2n
ZTime (s): cpu = 00:01:01 ; elapsed = 00:00:49 . Memory (MB): peak = 772.063 ; gain = 9.1522default:default
p

Phase %s%s
101*constraints2
...
C
7Phase 4.4.3 Dump Critical Paths  | Checksum: 19ec6bbea
*common
Ö

%s
*constraints2n
ZTime (s): cpu = 00:01:02 ; elapsed = 00:00:49 . Memory (MB): peak = 772.063 ; gain = 9.1522default:default
g

Phase %s%s
101*constraints2
...
:
.Phase 4.4.4 Restore STA | Checksum: 19ec6bbea
*common
Ö

%s
...
>
2Phase 4.4.5 Print Final WNS | Checksum: 19ec6bbea
*common
Ö

%s
*constraints2n
ZTime (s): cpu = 00:01:06 ; elapsed = 00:00:51 . Memory (MB): peak = 772.063 ; gain = 9.1522default:default
=
1Phase 4.4 Placer Reporting | Checksum: 19ec6bbea
*common
Ö

%s
...
D
8Phase 4.5 Final Placement Cleanup | Checksum: 1f906d3dc
*common
Ö

%s
...
ZTime (s): cpu = 00:01:06 ; elapsed = 00:00:51 . Memory (MB): peak = 772.063 ; gain = 9.1522default:default
S
GPhase 4 Post Placement Optimization and Clean-Up | Checksum: 1f906d3dc
*common
Ö

%s
*constraints2n
ZTime (s): cpu = 00:01:06 ; elapsed = 00:00:52 . Memory (MB): peak = 772.063 ; gain = 9.1522default:default
5
)Ending Placer Task | Checksum: 1f29b67ea
*common
Ö

%s
*constraints2n
ZTime (s): cpu = 00:00:00 ; elapsed = 00:00:52 . Memory (MB): peak = 772.063 ; gain = 9.1522default:default
Q
Releasing license: %s
83*common2"
...
772.0632default:default2
9.1522default:defaultZ17-268
^
...

sreport_utilization: Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.179 . Memory (MB): peak = 772.902 ; gain = 0.000
*common
j

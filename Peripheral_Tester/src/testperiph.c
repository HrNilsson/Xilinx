...
int main() 
{
...

   {
      ...
      print("\r\nRunning GpioInputExample() for sw_8bit...\r\n");

      u32 DataRead;
      
      status = GpioInputExample(XPAR_SW_8BIT_DEVICE_ID, &DataRead);
...

   {
      ...
      print("\r\nRunning GpioOutputExample() for led_8bit...\r\n");

      status = GpioOutputExample(XPAR_LED_8BIT_DEVICE_ID,8);
